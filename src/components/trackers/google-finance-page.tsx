...
export async function GoogleFinancePage({ db, userId, sp, year, month, currency, feesByMonth, range, query }: {
  ...
  return <div className="space-y-5">
    ...
    {campaigns.length > 0 && total.grossSpend == null && <p role="status" className="rounded border border-border bg-card p-3 text-xs text-muted-foreground">O script anterior enviava apenas o custo pago após crédito. Atualiza para o script v5 para importar também o gasto bruto. O lucro, o CPC, o CPM e o ROAS aguardam esse valor.</p>}
    {campaign ? <>
