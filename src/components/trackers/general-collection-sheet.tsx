...
export function GeneralCollectionSheet({ collection, year, month, currency, feesByMonth, query }: {
  ...
  return <section className="space-y-4">
    ...
    <p className="text-xs leading-relaxed text-muted-foreground">Conta a encomenda paga completa quando contém pelo menos um produto desta coleção, qualquer que seja a origem. Inclui os extras pagos do AfterSell, portes, reembolsos, custos e taxas. Encomendas pendentes, apenas autorizadas ou parcialmente pagas ficam de fora até o pagamento estar concluído. Cada encomenda conta uma vez por coleção; as sheets de coleções diferentes podem partilhar encomendas. Lucro = vendas líquidas − COGS − anúncios Meta e Google − taxas e comissões. O custo Google é bruto, antes de créditos.</p>
