    ...
    <div className="space-y-8">
      <section className="space-y-4">
        ...
        <div className="grid gap-4 xl:grid-cols-[1.6fr_1fr]">
          {Array.from({ length: 2 }).map((_, i) => <div key={i} className="space-y-3 rounded-xl border border-border bg-card p-5">
            <Skeleton className="h-4 w-32" /><Skeleton className="h-6 w-24" /><Skeleton className="h-10 w-full" />
          </div>)}
        </div>
      </section>
      <section className="space-y-4">
